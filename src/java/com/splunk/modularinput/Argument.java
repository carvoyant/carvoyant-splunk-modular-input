...
public class Argument {
    ...
    public Argument(String name, String title) {
        this.name = name;
        this.title = title;
    }
    ...
    /**
     * Gets the title that Splunk uses to represent this argument.
     *
     * @return The argument's title.
     */
    ...
    /**
     * Sets the title that Splunk will use to represent this argument.
     * 
     * @param title
     *      The title that Splunk will use to represent this argument.
     */
